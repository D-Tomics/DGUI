...
public class Buffers {
    ...
    public static FloatBuffer createFloatBuffer(float[] data) {
        return createFloatBuffer(data.length, data);
    }

    public static DoubleBuffer createDoubleBuffer(double[] data) {
        return createDoubleBuffer(data.length, data);
    }

    public static IntBuffer createIntBuffer(int[] data) {
        return createIntBuffer(data.length, data);
    }

    public static ByteBuffer createByteBuffer(byte[] data) {
        return createByteBuffer(data.length, data);
    }
